            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 py-4 flex flex-col md:flex-row my-10'>
                <div className='order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis laboriosam sunt perferendis voluptate, saepe enim provident dolorem tenetur facilis nostrum tempora, quos deleniti voluptatum?</p>
